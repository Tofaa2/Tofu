...
public class TofuLogger {
    ...
    public static void logInfo(String message){
        Tofu.getInstance().getServer().getConsoleSender().sendMessage(Messages.get(Messages.PREFIX) + Strings.cc( " &aINFO: " + message));
    }

    public static void logWarning(String message){
        Tofu.getInstance().getServer().getConsoleSender().sendMessage(Messages.get(Messages.PREFIX) + Strings.cc(" &eWARNING: " + message));
    }
