...
pub export var TOFU_vm: [*c]JavaVM = @import("std").mem.zeroes([*c]JavaVM);
pub export var TOFU_en: [*c]JNIEnv = @import("std").mem.zeroes([*c]JNIEnv);
pub export var MINECRAFT_CLASS: jclass = @import("std").mem.zeroes(jclass);
pub extern fn TOFU_jvm_init(...) void;
pub extern fn TOFU_classes_init(...) void;
